          ...
          <div className="glass-card p-10 space-y-7 relative overflow-hidden bg-white/70 shadow-xl border border-gray-200">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="flex justify-between items-center text-xs">
                ...
                <a href="#" className="font-bold text-[var(--color-text-secondary)] hover:text-[#0f172a] hover:underline">
                  Forgot password?
                </a>
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="liquid-glass-btn w-full py-4 rounded-xl text-sm font-bold text-white flex items-center justify-center gap-2 shadow-lg shadow-[var(--color-primary-glow)] disabled:opacity-70 disabled:cursor-not-allowed"
              >
